...
const Editable = Object.assign(editable$1.Editable, {
  Root: editable$1.Editable,
  Area: editableArea.EditableArea,
  CancelTrigger: editableCancelTrigger.EditableCancelTrigger,
  Control: editableControl.EditableControl,
  EditTrigger: editableEditTrigger.EditableEditTrigger,
  Input: editableInput.EditableInput,
  Label: editableLabel.EditableLabel,
  Preview: editablePreview.EditablePreview,
  SubmitTrigger: editableSubmitTrigger.EditableSubmitTrigger
});
