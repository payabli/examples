...
const SplitterResizeTrigger = react.forwardRef(
  (props, ref) => {
    const [triggerProps, restProps] = createSplitProps.createSplitProps()(props, [
      "disabled",
      "id",
      "step"
    ]);
    const { getResizeTriggerProps } = splitterContext.useSplitterContext();
    const mergedProps = react$1.mergeProps(getResizeTriggerProps(triggerProps), restProps);
