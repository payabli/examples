...
const HoverCard = Object.assign(hoverCard$1.HoverCard, {
  Root: hoverCard$1.HoverCard,
  Arrow: hoverCardArrow.HoverCardArrow,
  ArrowTip: hoverCardArrowTip.HoverCardArrowTip,
  Content: hoverCardContent.HoverCardContent,
  Positioner: hoverCardPositioner.HoverCardPositioner,
  Trigger: hoverCardTrigger.HoverCardTrigger
});
