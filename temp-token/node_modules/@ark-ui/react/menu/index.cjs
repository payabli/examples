...
const Menu = Object.assign(menu$1.Menu, {
  Root: menu$1.Menu,
  Arrow: menuArrow.MenuArrow,
  ArrowTip: menuArrowTip.MenuArrowTip,
  Content: menuContent.MenuContent,
  ContextTrigger: menuContextTrigger.MenuContextTrigger,
  Item: menuItem.MenuItem,
  ItemGroup: menuItemGroup.MenuItemGroup,
  ItemGroupLabel: menuItemGroupLabel.MenuItemGroupLabel,
  OptionItem: menuOptionItem.MenuOptionItem,
  Positioner: menuPositioner.MenuPositioner,
  Separator: menuSeparator.MenuSeparator,
  Trigger: menuTrigger.MenuTrigger,
  TriggerItem: menuTriggerItem.MenuTriggerItem
});
