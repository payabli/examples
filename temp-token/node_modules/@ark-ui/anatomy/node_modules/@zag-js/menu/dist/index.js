...
var dom = (0, import_dom_query.createScope)({
  ...
  isTargetDisabled: (v) => {
    return (0, import_dom_query.isHTMLElement)(v) && v.dataset.disabled === "";
  },
  isTriggerItem: (el) => {
  ...
  const api = {
    ...
    getItemProps(options) {
      ...
      return normalize.element({
        ...
        "data-highlighted": (0, import_dom_query2.dataAttr)(state.context.highlightedId === id),
  ...
  return (0, import_core2.createMachine)(
    {
      ...
      context: {
        ...
        hoverId: null,
        parent: null,
        children: (0, import_utils2.cast)((0, import_core2.ref)({})),
        intentPolygon: null,
        loop: false,
    ...
    },
    {
      ...
      actions: {
        ...
        setPositioning(ctx2, evt) {
          const getPositionerEl = () => dom.getPositionerEl(ctx2);
          const virtualAnchorEl = ctx2.anchorPoint ? {
            getBoundingClientRect: () => {
              const win = dom.getWin(ctx2);
              return win.DOMRect.fromRect({ width: 0, height: 0, ...ctx2.anchorPoint });
            }
          } : void 0;
          const anchorEl = virtualAnchorEl ?? dom.getTriggerEl(ctx2);
          void (0, import_popper2.getPlacement)(anchorEl, getPositionerEl, {
            ...ctx2.positioning,
            ...evt.options ?? {},
            listeners: false
          });
        ...
        invokeOnValueChange(ctx2, evt) {
          ...
          const valueAsArray = (0, import_utils2.isArray)(values) ? Array.from(values) : values;
        ...
        changeOptionValue(ctx2, evt) {
          ...
          const values = ctx2.value[name];
          if (type === "checkbox" && (0, import_utils2.isArray)(values)) {
            ctx2.value[name] = values.includes(value) ? (0, import_utils2.remove)(values, value) : (0, import_utils2.add)(values, value);
          } else {
