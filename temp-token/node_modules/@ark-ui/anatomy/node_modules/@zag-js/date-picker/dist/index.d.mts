...
import { DateValue, CalendarDate, CalendarDateTime, ZonedDateTime, DateDuration } from '@internationalized/date';
...
declare const anatomy: _zag_js_anatomy.AnatomyInstance<"cellTrigger" | "clearTrigger" | "content" | "control" | "grid" | "input" | "monthSelect" | "nextTrigger" | "positioner" | "prevTrigger" | "rowHeader" | "trigger" | "viewTrigger" | "yearSelect">;
...
type MonthGridValue = GridItem[][];
interface YearGridProps {
    columns?: number;
}
type YearGridValue = GridItem[][];
...
export { MachineApi as Api, CellProps, UserDefinedContext as Context, DateView, DayCellProps, GridProps, Offset, SelectionMode, Send, State, ViewProps, anatomy, connect, machine };
