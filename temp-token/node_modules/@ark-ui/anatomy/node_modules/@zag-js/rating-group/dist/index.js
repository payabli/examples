...
var anatomy = (0, import_anatomy.createAnatomy)("rating-group").parts("root", "label", "rating", "control");
  ...
  return {
    ...
    getRatingProps(props) {
      ...
      return normalize.element({
        ...
        "data-checked": (0, import_dom_query2.dataAttr)(itemState.isChecked),
        "aria-posinset": index,
        "data-highlighted": (0, import_dom_query2.dataAttr)(itemState.isHighlighted),
        "data-half": (0, import_dom_query2.dataAttr)(itemState.isHalf),
        onPointerDown(event) {
          if (!isInteractive)
            return;
    ...
    },
    {
      ...
      actions: {
        ...
        setNextValue(ctx2) {
          ...
          set.value(ctx2, Math.min(ctx2.max, value + factor));
        },
        setValueToMin(ctx2) {
          set.value(ctx2, 1);
        },
...
var set = {
  ...
  hoveredValue: (ctx, value) => {
    if ((0, import_utils.isEqual)(ctx.hoveredValue, value))
      return;
