    ...
    },
    {
      ...
      actions: {
        ...
        highlightNextItem(ctx2) {
          const value = ctx2.collection.next(ctx2.highlightedValue) ?? ctx2.collection.first();
          set.highlightedItem(ctx2, value);
        },
        highlightPrevItem(ctx2) {
          const value = ctx2.collection.prev(ctx2.highlightedValue) ?? ctx2.collection.last();
          set.highlightedItem(ctx2, value);
        },
