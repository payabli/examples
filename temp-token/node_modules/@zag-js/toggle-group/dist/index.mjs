...
var anatomy = createAnatomy("toggle-group").parts("root", "toggle");
  ...
  return {
    ...
    getToggleProps(props) {
      ...
      return normalize.button({
        ...
        onKeyDown(event) {
          if (isDisabled || !isSelfEvent(event))
            return;
