...
var dom = (0, import_dom_query.createScope)({
  ...
  getNextSliderTriggerId: (ctx) => ctx.ids?.nextSlideTrigger ?? `carousel:${ctx.id}:next-slide-trigger`,
  getPrevSliderTriggerId: (ctx) => ctx.ids?.prevSlideTrigger ?? `carousel:${ctx.id}:prev-slide-trigger`,
  ...
  getSlideGroupEl: (ctx) => dom.getById(ctx, dom.getSlideGroupId(ctx)),
...
var getAlignment = (align, containerSize) => {
  ...
  return (n) => {
    if ((0, import_utils.isNumber)(align))
      return percent();
  ...
  return {
    ...
    getSlideProps(props) {
      ...
      return normalize.element({
        ...
        "data-inview": (0, import_dom_query2.dataAttr)(sliderState.isInView),
        role: "group",
    ...
    getIndicatorProps(props) {
      ...
      return normalize.button({
        ...
        "data-current": (0, import_dom_query2.dataAttr)(index === state.context.index),
        onClick() {
          if (readOnly)
            return;
...
function machine(userContext) {
  ...
  return (0, import_core.createMachine)(
    ...
    },
    {
      ...
      actions: {
        scrollToNext(ctx2) {
          const index = (0, import_utils3.nextIndex)(ctx2.slideRects, ctx2.index);
          set.index(ctx2, index);
        },
        scrollToPrev(ctx2) {
          const index = (0, import_utils3.prevIndex)(ctx2.slideRects, ctx2.index);
          set.index(ctx2, index);
        },
        setScrollSnaps(ctx2) {
...
var set = {
  index: (ctx, index) => {
    if ((0, import_utils3.isEqual)(ctx.index, index))
      return;
    ctx.index = index;
