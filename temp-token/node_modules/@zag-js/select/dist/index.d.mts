...
import { CollectionItem, Collection, CollectionOptions } from '@zag-js/collection';
...
declare const anatomy: _zag_js_anatomy.AnatomyInstance<"label" | "positioner" | "trigger" | "clearTrigger" | "item" | "itemText" | "itemIndicator" | "itemGroup" | "itemGroupLabel" | "content" | "root" | "control">;
...
type ValueChangeDetails<T extends CollectionItem = CollectionItem> = {
    value: string[];
    items: T[];
};
type HighlightChangeDetails<T extends CollectionItem = CollectionItem> = {
    value: string | null;
    item: T | null;
};
type PublicContext<T extends CollectionItem = CollectionItem> = DirectionProperty & CommonProperties & InteractOutsideHandlers & {
    /**
     * The item collection
     */
...
type ItemProps<T extends CollectionItem = CollectionItem> = {
    item: T;
};
type ItemState = {
    value: string;
...
type MachineApi<T extends PropTypes = PropTypes, V extends CollectionItem = CollectionItem> = {
    /**
...
export { MachineApi as Api, UserDefinedContext as Context, ItemGroupLabelProps, ItemGroupProps, ItemProps, ItemState, anatomy, collection, connect, machine };
