...
var dom = (0, import_dom_query.createScope)({
  ...
  getTagElements: (ctx) => (0, import_dom_query.queryAll)(dom.getRootEl(ctx), `[data-part=tag]:not([data-disabled])`),
  ...
  return {
    ...
    getTagProps(options) {
      ...
      return normalize.element({
        ...
        "data-value": value,
        "data-disabled": (0, import_dom_query2.dataAttr)(isDisabled),
        "data-highlighted": (0, import_dom_query2.dataAttr)(id === state.context.focusedId),
        onPointerDown(event) {
          if (!isInteractive)
            return;
          event.preventDefault();
  ...
  return (0, import_core.createMachine)(
    ...
    },
    {
      ...
      actions: {
        ...
        focusNextTag(ctx2) {
          if (ctx2.focusedId == null)
            return;
          const next = dom.getNextEl(ctx2, ctx2.focusedId);
          if (next == null)
            return;
          set.focusedId(ctx2, next.id);
        },
        focusFirstTag(ctx2) {
        ...
        focusLastTag(ctx2) {
          ...
          if (last == null)
            return;
          set.focusedId(ctx2, last.id);
        },
        focusPrevTag(ctx2) {
          if (ctx2.focusedId == null)
            return;
          const prev = dom.getPrevEl(ctx2, ctx2.focusedId);
          set.focusedId(ctx2, prev?.id || null);
        },
        focusTag(ctx2, evt) {
          set.focusedId(ctx2, evt.id);
        },
        ...
        setEditedId(ctx2, evt) {
          ctx2.editedTagId = evt.id ?? ctx2.focusedId;
        ...
        syncEditedTagInputValue(ctx2, evt) {
          const id = ctx2.editedTagId || ctx2.focusedId || evt.id;
          if (id == null)
            return;
...
var set = {
  ...
  focusedId: (ctx, id) => {
    if ((0, import_utils.isEqual)(ctx.focusedId, id))
      return;
    ctx.focusedId = id;
