...
var getInitialContext = (ctx) => {
  ...
  let focusedValue = value.at(0) || ctx.focusedValue || getTodayDate2(timeZone);
  ...
  return createMachine(
    {
      ...
      computed: {
        valueText: (ctx2) => ctx2.value.map((date) => formatSelectedDate(date, null, ctx2.locale, ctx2.timeZone)).join(", "),
