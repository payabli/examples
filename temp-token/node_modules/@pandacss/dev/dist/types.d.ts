...
interface InitCommandFlags extends Pick<Config, 'jsxFramework' | 'syntax' | 'cwd' | 'poll' | 'watch' | 'gitignore' | 'outExtension'> {
    force?: boolean;
    postcss?: boolean;
    silent?: boolean;
    interactive?: boolean;
...
export { AnalyzeCommandFlags, CodegenCommandFlags, CssGenCommandFlags, DebugCommandFlags, InitCommandFlags, MainCommandFlags, ShipCommandFlags, StudioCommandFlags };
