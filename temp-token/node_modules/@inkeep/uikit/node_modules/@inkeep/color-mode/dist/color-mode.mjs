...
var useColorMode = () => useContext(ColorModeContext) ?? defaultContext;
...
var ColorModeProvider = (props) => {
  ...
  return /* @__PURE__ */ jsx(ColorMode, { ...props });
};
var noop = () => {
};
var forcedDark = {
...
var DarkModeProvider = ({
  ...
  return /* @__PURE__ */ jsx(ColorModeContext.Provider, { value: forcedDark, children: /* @__PURE__ */ jsx("div", { "data-theme": "dark", children }) });
};
...
var ColorMode = ({
  ...
  const applyColorMode = useCallback((colorMode2) => {
  ...
  return /* @__PURE__ */ jsxs(ColorModeContext.Provider, { value: providerValue, children: [
    /* @__PURE__ */ jsx(
      ColorModeScript,
      {
        ...{
...
var ColorModeScript = memo(
  ({
    ...
    return /* @__PURE__ */ jsx("script", { nonce, dangerouslySetInnerHTML: { __html: scriptSrc } });
  },
