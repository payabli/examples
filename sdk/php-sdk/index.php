...
<main class="container">
  <div style="overflow-x: auto; width: 100%;">
    <article style="display: inline-block; min-width: 100%; margin: 0; vertical-align: top;">
      <header style="padding: 10px;">
        <em><b>Customer List</b></em>
      </header>
      <table hx-get="/api/list" hx-swap="outerHTML" hx-trigger="load" hx-indicator="#spinner">
        </table>
    </article>
  </div>
</main>
